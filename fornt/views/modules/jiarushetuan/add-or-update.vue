<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="社团分类" prop="shetuanfenlei">
          <el-input v-model="ruleForm.shetuanfenlei" 
              placeholder="社团分类" clearable  :readonly="ro.shetuanfenlei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="社团分类" prop="shetuanfenlei">
              <el-input v-model="ruleForm.shetuanfenlei" 
                placeholder="社团分类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="加入理由" prop="jiaruliyou">
          <el-input v-model="ruleForm.jiaruliyou" 
              placeholder="加入理由" clearable  :readonly="ro.jiaruliyou"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="加入理由" prop="jiaruliyou">
              <el-input v-model="ruleForm.jiaruliyou" 
                placeholder="加入理由" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shetuanmingcheng = true;
          ...
          if(o=='shetuanfenlei'){
            this.ruleForm.shetuanfenlei = obj[o];
	    this.ro.shetuanfenlei = true;
            continue;
          }
          if(o=='zhanghao'){
	    ...
	    this.ro.zhanghao = true;
          ...
          if(o=='jiaruliyou'){
            this.ruleForm.jiaruliyou = obj[o];
	    this.ro.jiaruliyou = true;
            continue;
          }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jiarushetuan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jiarushetuanCrossAddOrUpdateFlag = false;
                  this.parent.search();
