<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="社团分类" prop="shetuanfenlei">
          <el-select v-model="ruleForm.shetuanfenlei" placeholder="请选择社团分类">
            <el-option
                v-for="(item,index) in shetuanfenleiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
  ...
  data() {
	...
	clicknum : false,
      ...
      rules: {
          ...
          shetuanfenlei: [
                { required: true, message: '社团分类不能为空', trigger: 'blur' },
          ],
          tupian: [
          ],
          chuangjianshijian: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
		...
		if(json.shezhangxingming!=''&&json.shezhangxingming){
