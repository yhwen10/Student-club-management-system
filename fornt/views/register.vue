  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(0, 150, 136, 1);fontSize:28px;">校园社团信息管理注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="社长姓名" class="input" v-if="tableName=='shezhang'">
			...
			<el-form-item label="学院" class="input" v-if="tableName=='shezhang'">
			  <el-input v-model="ruleForm.xueyuan" autocomplete="off" placeholder="学院"  />
			</el-form-item>
			<!-- <div v-if="tableName=='shezhang'" class="input-group">
			   <div class="label">班级</div>
			...
			<el-form-item label="班级" class="input" v-if="tableName=='shezhang'">
			  <el-input v-model="ruleForm.banji" autocomplete="off" placeholder="班级"  />
			</el-form-item>
			<!-- <div v-if="tableName=='shezhang'" class="input-group">
			   <div class="label">手机</div>
			...
			<el-form-item label="手机" class="input" v-if="tableName=='shezhang'">
			  <el-input v-model="ruleForm.shouji" autocomplete="off" placeholder="手机"  />
			</el-form-item>
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if(`shezhang` == this.tableName && this.ruleForm.shouji&&(!this.$validate.isMobile(this.ruleForm.shouji))){
        this.$message.error(`手机应输入手机格式`);
        return
      }
      this.$http({
